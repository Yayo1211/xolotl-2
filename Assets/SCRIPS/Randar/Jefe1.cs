...
public class Jefe1 : MonoBehaviour
{
    ...
    [Header("Ataque")]
    [SerializeField] private Transform ControladorAtaque1;
    ...
    public void Ataque()
    {
        Collider2D[] objetos = Physics2D.OverlapCircleAll(ControladorAtaque1.position, radioAtaque);
    ...
    private void OnDrawGizmos()
    {
        ...
        Gizmos.DrawWireSphere(ControladorAtaque1.position, radioAtaque);
    }
}
